...
setupVbenVxeTable({
  configVxeTable: (vxeUI) => {
    ...
    // add by from https://github.com/vbenjs/vue-vben-admin/blob/main/playground/src/adapter/vxe-table.ts#L97-L123
    ...
    // add by from https://github.com/vbenjs/vue-vben-admin/blob/main/playground/src/adapter/vxe-table.ts#L125-L255
